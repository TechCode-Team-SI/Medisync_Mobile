const stylesBoard = {
    ...
    imagePlaceholder: 'w-full h-44 justify-center items-center bg-gray-300 rounded-lg',
    description: 'text-gray-600 my-2 text-base ml-1  ',
    title: 'text-primary text-2xl font-bold pt-3 ml-1',
