const stylesSuggestion = {
    ...
    //// General////
    container1: "flex flex-reverse justify-flex-start  left-80  -mt-9 ml-9",
    container2: "bg-principal w-full flex-1 h-full",
    container3:"bg-Principal border-y-4 border-principal w-full h-40",
    ...
    export default stylesSuggestion;