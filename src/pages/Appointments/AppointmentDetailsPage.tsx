...
import { Appointment, getAppointmentDetails } from "@/src/services/request/requestServic";
import ButtonBack from "@/src/components/Navigation/ButtonBack";

const AppointmentDetailsPage = () => { 
 
  const { id, name, specialization, date, time, status, dni, doctor, gender, age} = useLocalSearchParams();  
  ...
  return ( 
    ...
    <View className={styles.containerBg1}> 
      ...
      <Text className={styles.title3}>Detalles de la consulta</Text>
