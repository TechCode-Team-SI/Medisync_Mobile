  ...
  return (
    <View className={styles.container}>
      ...
      <View className={styles.container2}>
        <TouchableOpacity className={styles.button} onPress={handleSuggestion}>
      ...
      <View className={styles.container2}>
        <TouchableOpacity className={styles.button} onPress={handleClaims}>
          <View className={styles.icon}>
      ...
      <View className={styles.container2}>
        <TouchableOpacity className={styles.button} onPress={handleHistory}>
          <View className={styles.icon}>
