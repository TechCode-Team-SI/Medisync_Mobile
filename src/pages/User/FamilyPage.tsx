...
const FamilyPage: React.FC = () => {
  ...
  const handleSelect = (patient: any) => {
    router.push(
      `/userfamily?fullName=${encodeURIComponent(
        patient.fullName
      )}&dni=${encodeURIComponent(patient.dni)}&birthday=${encodeURIComponent(
        patient.birthday
      )}&gender=${encodeURIComponent(
        patient.gender
      )}&familyRelationship=${encodeURIComponent(patient.familyRelationship)}`
    );
  };
